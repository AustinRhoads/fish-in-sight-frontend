...
class EditCatch extends Component {
    ...
    editProtect = (caught) => {
       ...
       if(caught.user_id !== currentUser.id){

            console.log(caught.user_id, currentUser.id)
    ...
    renderImageReview = () => {
        ...
        if(this.state.image_preview){
            return(
                ...
                <> 
                    <img alt="img-preview"  src={this.state.image_preview} style={{maxWidth: 100, maxHeight: 100}}></img>
                    <button className="image-preview-delete-button" onClick={e => this.unselectImage(e)}>-</button>
                </>
            )
        }
        ...
        <div>
            ...
            <p className="lat-lng">Lat: {this.state.center.lat} Lng: {this.state.center.lng}</p>
                 ...
                 <GoogleMapReact
                   ...
                   {this.renderSpeciesOptions()}
                    ...
                    <h3 className="slide-title">Review</h3>
                        <div className="image-preview-div" style={{height: 100, width: 100}} >
                             {this.renderImageReview()}
                             <br />
                        </div>
                        <div className="float-right-div">
                            <p>{this.selectedSpeciesName() }</p>
                            <p>Lat: {this.state.center.lat}, Lng: {this.state.center.lng}</p>
                            <p>Measurments: {this.state.inches}in.</p>
                            <p>Caught with: {this.selectedBaitName() }</p>
                ...
                <div className="dot-div">
                  ...
                  <button className="delete-catch-button" onClick={e => this.deleteCatch(e)} style={{marginTop: "33px"}}>Delete This Catch</button>
